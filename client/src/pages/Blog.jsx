    ...
    <div className=''>
      ...
      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
        ...
        <div className='mt-14 mb-10 max-w-3xl mx-auto'>
          <p className='mb-4 font-semibold'>Comments ({comment.length})</p>
          <div className='flex flex-col gap-4'>
            {
              comment.map((item, index) => (
                <div key={index} className='relative bg-primary/4 border border-primary/6 max-w-xl p-4 rounded-xl text-gray-600'>
